const classMethods = require("../hooks/classMethods");
const inheritance = require("../hooks/inheritance");
const instanceMethods = require("../hooks/instanceMethods");
const paranoidSchizophrenia = require("../hooks/paranoidSchizophrenia");
